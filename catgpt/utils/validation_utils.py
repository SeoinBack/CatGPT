...
class Crystal(object):
    def __init__(self, structure, tokenizer, classifier):
...
#        self.valid = True
        ...
        self.catal_valid, self.catal_score = catalyst_validity(self.structure, self.tokenizer, self.classifier)
