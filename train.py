...
params = OmegaConf.load('./config/config_mine.yml')
...
training_args = TrainingArguments(
    ...
    dataloader_num_workers=1,#data_params.num_workers,
...
shutil.copy('./config/config.yml',
            os.path.join('./outputs/' + f'{model_params.name}/', 'config.yml'))
